...
import checkout from "#/components/donation/screenshots/checkout.webp";
import form from "#/components/donation/screenshots/form.webp";
import result from "#/components/donation/screenshots/result.webp";
