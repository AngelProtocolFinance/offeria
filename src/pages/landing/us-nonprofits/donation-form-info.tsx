  ...
  return (
    ...
    >
      ...
      <p className="col-span-full text-center text-xl @6xl:text-2xl leading-normal max-w-3xl justify-self-center mt-8">
        As a 501(c)(3) public charity, Offeria accepts donations on your behalf,
        handling all reporting, processing, and tax receipting. We grant 100% of
        donations directly to your bank account, or save and invest a portion
