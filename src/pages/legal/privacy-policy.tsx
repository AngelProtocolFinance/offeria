  ...
  return (
    <div className="xl:container xl:mx-auto px-5 min-h-screen pb-6 prose pt-24">
      ...
      <p className="text-right">
        <em>Last modified: November 1, 2024</em>
      </p>
      <p>
      ...
      <ul>
        <li>
          <p>To present our Site and its contents to you.</p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        collected or used in this way. You can opt out of receiving targeted ads
      ...
      <ul>
        <li>
          ...
          information on the ways in which we use your personal data, categories
          of personal data concerned, recipients or categories of recipients to
          whom your data has been or will be disclosed, the right to lodge a
          complaint with a supervisory authority, the source of your personal
          data, and our use of automated decision-making in processing your
          data.{" "}
        </li>
        <li>To correct and update your personal data. </li>
        <li>
          To erase personal data, if that data is no longer necessary for the
          purpose it was collected or otherwise processed, if you object to the
          use of that data and a fundamental right is at stake, or if your
          personal data has been unlawfully processed. Where your data was made
          public, our responsibility to erase it is limited to deleting data in
          our possession, and taking reasonable steps to inform other data
          controllers of your request. In no event shall we have any obligation
          to erase your data where doing so would prevent exercise of the right
          of freedom of expression and information, would interfere with a legal
          obligation, would interfere with the processing of health data, would
          interfere with legitimate archiving, or would impede the
      ...
      <p>
        <strong>Your Privacy Rights Under California Law</strong>
      </p>
      <p>
      ...
      <p>
        This section provides additional details about the personal information
        we collect about California consumers and the rights afforded to them
      ...
      <p>
        ...
        personal information we collect (including how we use and disclose this
