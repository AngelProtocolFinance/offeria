  ...
  return (
    <main className="prose lg:prose-lg xl:container xl:mx-auto px-5 py-20">
      ...
      <p>
        ...
        <b>Donors</b>”) and <b>Offeria</b>, Inc. (“Offeria,” “<b>we</b>,” “
        <b>us</b>,” or “<b>our</b>”). Offeria is a public charity recognized by
        the Internal Revenue Service (the “IRS”) under Section 501(c)(3) of the
        Internal Revenue Code (Federal Tax ID # 87-3758939).
      </p>
      <p>
        Offeria provides and offers a charitable giving platform (the “
        <b>Platform</b>”) which enables Donors to make charitable contributions
        to Offeria and make grant recommendations to qualified nonprofit
        organization(s) (“<b>NPOs</b>”) on the Platform to advance their
        missions. Offeria accepts contributions of fiat currency, cryptocurrency
      ...
      <p>
        ...
        sustainable grant funding, at Offeria's sole discretion.
      </p>
      <p>
        By making donations to Offeria, you acknowledge and represent that you
        (i) agree that these Terms are supported by reasonable, valuable and
      ...
      <ol>
        <li>
          ...
          <ol className="list-[lower-alpha]">
            <li>
              ...
              Offeria, a public charity recognized by the Internal Revenue
              Service as a tax-exempt organization under Internal Revenue Code
              501(c)(3). You understand, acknowledge and agree that all
              donations made to Offeria are irrevocable, unrestricted and
              non-refundable charitable contributions and that Offeria has full
              and exclusive legal control over any and all donated funds or
              assets.
            </li>
            <li>
              <b>Authority</b>. By making a donation to Offeria, you hereby
              represent and warrant that you have the legal authority to make a
              donation and that any and all funds or assets donated to Offeria
              belong to you and are free and clear of any and all encumbrances.
              Offeria will provide you with a receipt for your donation in
            ...
            <li>
              ...
              longer eligible to receive grants from Offeria, we will issue
            ...
            <li>
              <b>Compliance</b>. All donations made to Offeria must comply with
              Offeria's Gift Acceptance Policy, and Offeria reserves the right
              in its sole discretion to deny any gift or donation made on the
              Platform. By making a donation to Offeria, you represent and
              warrant that you are not a restricted individual or entity as
              identified by the Office of Foreign Assets Control (OFAC).
            </li>
            <li>
              <b>Grant Recommendations</b>: When you make a donation to Offeria,
              you may recommend a specific qualified NPO to be supported by your
              donation to Offeria.{" "}
              <U>
            ...
            <li>
              ...
              fulfilling a grant recommendation rests with Offeria.
            </li>
            <li>
              <b>Donor Fees</b>. NPOs may elect to have Donor Fees set as either
              (1) an optional donation to Offeria at the Donor’s sole
              discretion; or (2) a flat 1.5% fee on all donations made. There
              may be additional transaction fees for donations of
              cryptocurrency, over which Offeria has no control.
            </li>
            <li>
              <b>Charitable Use</b>. Donations made to Offeria may only be used
              for charitable purposes in accordance with any and all applicable
              local, state, federal or national laws. In compliance with the
              Internal Revenue Code, grants are not permitted to individuals;
              for non-charitable purposes; for political purposes or to support
              political campaign activities; or for any purpose that would
              provide benefits, goods or services to Donors or other related
              parties.
            </li>
          </ol>
        </li>
        <li>
          ...
          <p>
            ...
            contributed to Offeria for their support. Specifically, NPOs may
          ...
          <ol className="list-[lower-alpha]">
            <li>
              ...
              discretion of Offeria.
            </li>
            <li>
              <b>Money-Market</b> (“Savings”). Donations allocated to Savings
              are maintained in a money-market account to accrue interest until
              the NPO makes a grant request (“Withdrawal”) to Offeria. Unless a
              different investment recommendation is made by NPO, all donations
              are automatically allocated to Savings.
            </li>
            <li>
              <b>Sustainability Fund</b> (“Investment”). Donations allocated to
              Investment are maintained in the Offeria Sustainability Fund and
              are invested per Offeria's Investment Policy. Assets in the Fund
              are unrestricted contributions and per the Investment Policy both
              principal and income are available for expenditure by Offeria.
              Although we view contributions in the Fund as long-term
              investments with principal remaining intact to support NPO’s in
              furtherance of our mission, we also believe in an NPO’s right to
              organizational autonomy and allow for Withdrawal at the discretion
              of Offeria.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol className="list-[lower-alpha]">
            <li>
              You agree to indemnify, hold harmless, and, defend Offeria and its
              affiliates and each of its and their officers, directors,
              ...
              Terms. Offeria reserves the right to assume the exclusive defense
              and control of any matter otherwise subject to indemnification by
              you and, in such case, you agree to cooperate with Offeria'
        ...
        <li>
          ...
          to Offeria and any tax deductions you may be eligible for, you should
          ...
          deductibility and tax consequences of any donation(s) made to Offeria.
        </li>
        <li>
          ...
          <ol className="list-[lower-alpha]">
            ...
            <li>
              <b>Dispute Resolution</b>. Any dispute between you and Offeria
              ...
              Offeria for which monetary damages would be an inadequate remedy.
              Accordingly, we have the right, without the necessity of posting
              bond, to seek injunctive or other equitable relief from any court
              of competent jurisdiction to protect our rights in intellectual
