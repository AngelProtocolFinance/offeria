...
export default [
  ...
  r(
    ...
    [
      ...
      r("investments", pages.$("fund-management/investments/index.tsx")._, [
        ...
        r(
          "log-dividends",
          pages.$("fund-management/investments/log-dividends/index.tsx")._
        ),
      ]),
      r(
  ...
  layout(layouts.$("app/layout.tsx")._, [
    ...
    r("terms-of-use-sms", legal.$("terms-sms.tsx")._),
    r("banking-applications", bank_apps.$("index.tsx")._),
    r("fundraiser-moderation", pages.$("fundraiser-moderation/index.tsx")._),
  ...
  r("api/donation-intents", "./routes/donation-intents/index.ts"),
  ...
  r("api/npos/dividend-log-simul", "./routes/npo-dividend-log-simul.ts"),
  r("api/irs-npos-aggregates/:type", "./routes/irs-npos-aggregates.ts"),
  r("api/irs-npos/export", "./routes/irs-npos-export.ts"),
  r("api/tokens", "./routes/tokens.ts"),
  r("api/tokens/:code/estimate", "./routes/token-estimate.ts"),
  r("api/tickers", "./routes/tickers.ts"),
  r("api/tickers/:symbol/estimate", "./routes/ticker-estimate.ts"),
